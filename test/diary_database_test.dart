...
void main() {
  ...
  test('全てのタグを取得し、使用頻度順に並んでいるかどうか', () async {
    ...
    await DiaryDatabase.instance.createDiary(diary);
    await DiaryDatabase.instance.createDiary(diary2);
    await DiaryDatabase.instance.createDiary(diary3);

    // Get all tags sorted by usage
    List<String> tags = await database.fetchAllTagsSortedByUsage();
    print(tags);
    // 最初の三要素だけを取得
